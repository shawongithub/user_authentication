...
def login_page(request):
    dict={}
    return render(request,'Login_app/login.html',dict)
...
def register(request):
    ...
    if request.method=='POST':
        ...
        user_info_form=UserInfoForm(data=request.POST or None)
    ...
    return render(request,'Login_app/register.html',dict)